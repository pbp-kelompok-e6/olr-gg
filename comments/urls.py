...
from comments.views import get_comments_json,show_comments, edit_comment, delete_comment, add_comment,api_create_comments,api_edit_news,api_delete_news
...
urlpatterns = [
    ...
    path('<uuid:comment_id>/edit_flutter/', api_edit_news, name='edit_comment_flutter'),
    path('<uuid:comment_id>/delete_flutter/', api_delete_news, name='delete_comment_flutter'),
